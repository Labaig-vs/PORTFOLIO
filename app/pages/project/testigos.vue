...
const props = defineProps({
  ...
  projectDescription: {
    type: String,
    default: 'TESTIGOS es un proyecto que investiga cómo los sistemas de poder, control y representación se manifiestan a través de la tecnología, el lenguaje y los rastros que dejamos como sujetos contemporáneos. Funciona como un archivo crítico que observa, registra y reinterpreta comportamientos individuales y colectivos en un contexto donde la vigilancia, la automatización y la mediación algorítmica son estructurales. El proyecto no se limita a documentar, sino que construye relatos y dispositivos visuales que ponen en tensión la relación entre individuo, Estado y máquina. TESTIGOS propone una mirada activa, casi forense, sobre cómo somos observados y cómo, al mismo tiempo, nos convertimos en testigos de nuestra propia exposición.'
  },
  projectSections: {
    type: Array,
    default: () => [
      {
        title: '',
        layout: 'double', // 'single', 'double', 'triple'
        images: [
          {
            src: '/images/Testigos/poster.png',
            alt: '',
            caption: '',
            // padding: '2rem',
            // paddingTop: '1rem',
          ...
          {
            src: '/images/Testigos/Portada.png',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/Testigos/publicacion2.png',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/Testigos/publicacion3.png',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/Testigos/publicacion4.png',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/Testigos/publicacion5.png',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/Testigos/publicacion6.png',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/Testigos/publicacion7.png',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/Testigos/publicacion8.png',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/Testigos/publicacion9.png',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/Testigos/publicacion10.png',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/Testigos/publicacion11.png',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/Testigos/publicacion12.png',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
