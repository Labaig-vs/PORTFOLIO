...
const props = defineProps({
  projectTitle: {
    type: String,
    default: 'L\'IMPERO DELL\'OMBRA'

  },
  projectDescription: {
    type: String,
    default: 'CLUSTER es un sistema tipográfico vivo que traduce el espacio en forma. La tipografía se comporta como una superficie activa que registra la presencia, la presión y la energía colectiva, haciendo visible cómo el entorno deja huella en el lenguaje.'
  },
  projectSections: {
    type: Array,
    default: () => [
      {
        ...
        images: [
          {
            src: '/images/EUR/book-horizontal_9.jpg',
            alt: '',
            caption: '',
            // padding: '2rem',
            // paddingTop: '1rem',
          ...
          {
            src: '/images/EUR/book-horizontal_2.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/EUR/book-horizontal_3.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/EUR/book-horizontal_4.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/EUR/book-horizontal_5.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/EUR/book-horizontal_6.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/EUR/book-horizontal_7.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/EUR/book-horizontal_8.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/EUR/book-horizontal_9.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/EUR/book-horizontal_10.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/EUR/book-horizontal_11.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
