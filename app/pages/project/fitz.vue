...
const props = defineProps({
  projectTitle: {
    type: String,
    default: 'FITZ PLEASURE'
  },
  projectDescription: {
    type: String,
    default: 'Audiovisuales generativos en tiempo real con Resolume para la proyección en salas. En este caso, asociado a la canción Fitz Pleasure de alt-J. En colaboración con Ruben ROdriguez, Antonio Clemente y Selena Prada'
  },
  projectSections: {
    type: Array,
    default: () => [
      {
        ...
        images: [
          {
            src: '/images/FitzPleasure/FitzPleasure.mp4',
            alt: '',
            caption: '',
            // padding: '2rem',
            // paddingTop: '1rem',
