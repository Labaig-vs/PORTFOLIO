...
const props = defineProps({
  ...
  projectDescription: {
    type: String,
    default: 'ARDE es la identidad visual para un estudio de diseño gráfico y comunicación ubicado en Madrid, España. El proyecto se centra en crear una imagen cercana y contemporánea que refleje la creatividad y profesionalismo del estudio.'
  },
  projectSections: {
    type: Array,
    default: () => [
      {
        ...
        images: [
          ...
          {
            src: '/images/ARDE/letrerobyw.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/ARDE/poster2.4.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
