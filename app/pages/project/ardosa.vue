...
const props = defineProps({
  ...
  projectDescription: {
    type: String,
    default: 'ARDOSA es la identidad visual para unos de los bares más míticos de Madrid: LA BODEGA DE LA ARDOSA. Se ha rediseñado el logotipo, las etiquetas de sus botellas de cerveza y vino, así como diversos elementos gráficos para su comunicación tanto en formato físico como digital. El objetivo principal ha sido mantener la esencia tradicional del bar, al mismo tiempo que se le da un toque moderno y fresco que atraiga a una audiencia más joven.'
  },
  projectSections: {
    type: Array,
    default: () => [
      {
        ...
        images: [
          {
            src: '/images/Ardosa/logotipo_neg-display.svg',
            alt: '',
            caption: '',
            background: '#ffffff',
            padding: '2rem',
          ...
          {
            src: '/images/Ardosa/mockup-vino1.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/Ardosa/mockup-vino3.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/Ardosa/mockup-vino2.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/Ardosa/botellin2-blanco.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/Ardosa/botellin2-negro.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
          ...
          ,
          {
            src: '/images/Ardosa/mockup_tortillas2.webp',
            alt: '',
            caption: '',
            // padding: '2rem',
            paddingTop: '0rem',
